...
def create_wind_vector_plot(fileName_u, fileName_v, pressureLevel, dvdiff, totalYears=15):
    ...
    contour = ax.contourf(wind_speed.lon, wind_speed.lat, wind_speed, levels=20, cmap='YlOrRd', transform=ccrs.PlateCarree())
    ...
    quiver = ax.quiver(ua_at_level.lon[::skip], ua_at_level.lat[::skip],
                      ...
                      scale=400,  # Adjust to change arrow length
    ...
    plt.title(f'Vertical Diffusion Coefficient = {dvdiff} m\u00b2/s: Mean Wind at {pressureLevel/100:.0f} hPa', 
             fontsize=14, fontweight='bold')
    
    plt.tight_layout()
    plt.savefig(f'{fileName_u}_{fileName_v}_wind_vectors_{pressureLevel/100:.0f}hPa.png', 
...
def create_eastward_wind_graph(file1, file2, file3, label1, label2, label3, ymin, pressureLevel, totalYears=15):
    ...
    plt.title(f'Eastward (u) Wind Velocity Time Evolution at {pressureLevel/100:.0f} hPa', 
                fontsize=15, fontweight='bold')
    plt.grid(True, alpha=0.3, linestyle='--')
    plt.legend(fontsize=11, loc='best', title='Vertical Diffusion Coefficient')
    plt.ylim(bottom=ymin)
    plt.tight_layout()
    plt.savefig(f'ua_comparison_{pressureLevel/100:.0f}hPa.png', dpi=300)
    plt.show()
...
def create_northward_wind_graph(file1, file2, file3, label1, label2, label3, pressureLevel, totalYears=15):
    plt.figure(figsize=(14, 6))
    ...
    plt.title(f'Northward (v) Wind Velocity Time Evolution at {pressureLevel/100:.0f} hPa', 
                fontsize=15, fontweight='bold')
    plt.grid(True, alpha=0.3, linestyle='--')
    plt.legend(fontsize=11, loc='best', title='Vertical Diffusion Coefficient')
    plt.tight_layout()
    plt.savefig(f'va_comparison_{pressureLevel/100:.0f}hPa.png', dpi=300)
    plt.show()
...
def create_wind_difference_plot(fileName_u_ref, fileName_v_ref, fileName_u_exp, fileName_v_exp, pressureLevel, dvdiff, totalYears=15):
    ...
    plt.title(f'Difference Between {dvdiff} & 0 m\u00b2/s: Mean Wind Difference at {pressureLevel/100:.0f} hPa',
              fontsize=14, fontweight='bold')
...
create_wind_vector_plot('code_131-DVDIFF0',     'code_132-DVDIFF0',     50000, 0)
create_wind_vector_plot('code_131-DVDIFF5',     'code_132-DVDIFF5',     50000, 5)
create_wind_vector_plot('code_131-DVDIFF10',    'code_132-DVDIFF10',    50000, 10)
create_wind_vector_plot('code_131-DVDIFF0',     'code_132-DVDIFF0',     85000, 0)
create_wind_vector_plot('code_131-DVDIFF5',     'code_132-DVDIFF5',     85000, 5)
create_wind_vector_plot('code_131-DVDIFF10',    'code_132-DVDIFF10',    85000, 10)
create_wind_vector_plot('code_131-DVDIFF0',     'code_132-DVDIFF0',     100000, 0)
create_wind_vector_plot('code_131-DVDIFF5',     'code_132-DVDIFF5',     100000, 5)
create_wind_vector_plot('code_131-DVDIFF10',    'code_132-DVDIFF10',    100000, 10)

create_eastward_wind_graph('code_131-DVDIFF0', 'code_131-DVDIFF5', 'code_131-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', 5.5, 50000)
create_eastward_wind_graph('code_131-DVDIFF0', 'code_131-DVDIFF5', 'code_131-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', 0.8, 85000)
create_eastward_wind_graph('code_131-DVDIFF0', 'code_131-DVDIFF5', 'code_131-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', -0.3, 100000)

create_northward_wind_graph('code_132-DVDIFF0', 'code_132-DVDIFF5', 'code_132-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', 50000)
create_northward_wind_graph('code_132-DVDIFF0', 'code_132-DVDIFF5', 'code_132-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', 85000)
create_northward_wind_graph('code_132-DVDIFF0', 'code_132-DVDIFF5', 'code_132-DVDIFF10', '0 m\u00b2/s', '5 m\u00b2/s', '10 m\u00b2/s', 100000)

create_wind_difference_plot('code_131-DVDIFF0', 'code_132-DVDIFF0', 'code_131-DVDIFF10', 'code_132-DVDIFF10', 50000, 10)
create_wind_difference_plot('code_131-DVDIFF0', 'code_132-DVDIFF0', 'code_131-DVDIFF10', 'code_132-DVDIFF10', 85000, 10)
create_wind_difference_plot('code_131-DVDIFF0', 'code_132-DVDIFF0', 'code_131-DVDIFF10', 'code_132-DVDIFF10', 100000, 10)